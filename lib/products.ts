...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Hand-turned spindle cradle with rocker base — built to last generations.",
    longDescription:
      "A true heirloom piece. Andy hand-turns every spindle and fits them into a solid pine frame with a gentle rocker base that lets the cradle swing smoothly. Finished with a rich walnut stain. Built to be passed down — not mass-produced, not flat-packed. Every one is made to order.",
    price: 0,
    priceOnRequest: true,
    category: "Furniture",
    images: ["/products/baby-cradle.jpg"],
    wood: "Pine",
    inStock: true,
    featured: true,
  },
