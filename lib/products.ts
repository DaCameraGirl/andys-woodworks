...
export const products: Product[] = [
  ...
  {
    id: "baby-cradle",
    name: "Heirloom Baby Cradle",
    description: "Hand-built baby cradle with rocker base — built to last generations.",
    longDescription:
      "A true heirloom piece. Andy builds each cradle by hand — solid sides with scalloped detail, spindle styles, whatever the customer needs. Gentle rocker base, finished in your choice of stain. The photos show different styles and stages — from raw pine to finished. Built to be passed down. Every one is made to order.",
    price: 0,
    priceOnRequest: true,
    category: "Furniture",
    images: [
      "/products/baby-cradle.jpg",
      "/products/Baby_Crib.jpg",
      "/products/Unfinished_Baby_Crib_2.jpg",
      "/products/Unfinished_Baby_Crib.jpg",
      "/products/Unfinished_Baby_Crib1.1.jpg",
      "/products/Finished_Crib_Rails.jpg",
      "/products/Unfinished_Crib_Rails.jpg",
    ],
    wood: "Pine",
    inStock: true,
    featured: true,
