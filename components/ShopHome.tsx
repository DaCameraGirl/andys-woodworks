...
export default function ShopHome({ activeCategory }: ShopHomeProps) {
      ...
      <section className="py-16 px-4" style={{ background: "var(--bg-surface)", borderTop: "1px solid var(--border)" }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mb-6" style={{ color: "var(--text-muted)" }}>
            Andy takes on a limited number of custom orders each month. Reach out early with dimensions, finish ideas, and timeline.
          </p>
          <Link
            href="/contact"
